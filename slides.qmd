...
-   [Before adding dependencies]{.blue}, 
    -   Make sure it [works as intended]{.blue}
    -   Check if they are [maintained]{.blue} and the size of the user base
:::

:::fragment
-   Be aware of [security risks]{.blue}
    - [PyTorch vulnerability](https://johnstawinski.com/2024/01/11/playing-with-fire-how-we-executed-a-critical-supply-chain-attack-on-pytorch/)
